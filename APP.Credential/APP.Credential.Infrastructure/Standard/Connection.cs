...
namespace APP.Credential.Infrastructure
{
    public class Connection
    {
        ...
        public string UserEmployeeConnectionString(Enumeration.ApplicationMode ApplicationMode)
        {
            if (ApplicationMode == Enumeration.ApplicationMode.Development)
            {
                return eOfficeConnectionDev;
            }
            else if (ApplicationMode == Enumeration.ApplicationMode.Testing)
            {
                return eOfficeConnectionTst;
            }
            else if (ApplicationMode == Enumeration.ApplicationMode.Production)
            {
                return eOfficeConnectionPrd;
            }
            else
            {
                return "";
        ...
        private string APPConnectionDev
        {
            ...
            {
                string returnValue = "";
                returnValue = "Data Source=IDSRGVPDBS02;Initial Catalog=master_data;Persist Security Info=True;User ID=eoffice;Password=xxx;" + SQLProfilerInfo;
                return returnValue;
            }
        }
        ...
        private string eOfficeConnectionDev
        {
            get
            {
                string returnValue = "";
                returnValue = "Data Source=IDSRGVPDBS02;Initial Catalog=User_Registration;Persist Security Info=True;User ID=eoffice;Password=xxx;" + SQLProfilerInfo;
                return returnValue;
            }
        }

        private string eOfficeConnectionTst
        {
            get
            {
                string returnValue = "";
        ...
        private string eOfficeConnectionPrd
        {
            get
            {
                string returnValue = "";
